...
-- NOTE: This doesn't work with parseIso8601Strict because each line has a
-- trailing Line Feed (\n). This is required by UNIX definition of a line. The
-- line feed is not read by the parser and the function fails accordingly.
